...
BunnyDefender.Game.prototype = {
	...
	buildSpaceRocks: function() {
	    ...
	    var i, r, scale;
	    for (i = 0; i < this.totalSpacerocks; i++) {
	        r = this.spacerockgroup.create(
	...
	buildBunnies: function() {
	    ...
	    var i, b;
	    for (i = 0; i < this.totalBunnies; i++) {
	        b = this.bunnygroup.create(
	...
	assignBunnyMovement: function(b) {
	    ...
	    var t = this.add.tween(b).to(
		    ...
		    true,
		    bdelay
	    ); //properties, duration, ease, autoStart, delay
